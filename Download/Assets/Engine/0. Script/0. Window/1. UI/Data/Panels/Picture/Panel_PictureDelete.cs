...
public class Panel_PictureDelete : Panel_Popup
{
    private RectTransform m_rectTransform;
    private TMP_Text m_text;

    public Panel_PictureDelete() : base()
    {
        m_fileType = WindowManager.FILETYPE.TYPE_PICTUREDELETE;
    }
    ...
    public override void Load_Scene()
    {
        ...
        m_object = GameManager.Ins.Resource.LoadCreate("5. Prefab/0. Window/UI/Picture/Panel_PictureDelete", canvas.GetChild(3));
    ...
    {
        Active_Popup(false);
        GameManager.Ins.Window.Picture.Remove_SelectData();
    }
