...
{
    public class Novel_Day3Shoot : Novel_Level
    {
        ...
        public override void Enter_Level()
        {
            ...
            dialog.Reset_Skip();
            manager.Dialog.SetActive(false);
        ...
        private void GameOver_ShootGame()
        {
            ...
            if (m_overTime > 1.5f)
            {
                ...
                else if (!m_shootGameNext && m_overTime > 3) // 3) 1.5초 뒤 페이드 아웃으로 전환
                {
                    ...
                    GameManager.Ins.UI.Start_FadeOut(1f, Color.black, () => m_levelController.Change_Level((int)VisualNovelManager.LEVELSTATE.LS_DAY3AFTER), 0.5f, false);
                }
            }
        }
