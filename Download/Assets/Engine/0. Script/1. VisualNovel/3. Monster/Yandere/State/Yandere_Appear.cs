...
namespace VisualNovel
{
    public class Yandere_Appear : State<HallwayYandere>
    {
        ...
        public override void Enter_State()
        {
            ...
            clothA.GetComponent<SkinnedMeshRenderer>().materials[0].SetTexture("_BaseMap", GameManager.Ins.Resource.Load<Texture2D>("1. Graphic/3D/1. VisualNovel/Character/Texture/Yandere/Pink_UV_ClothA_BaseMap"));
