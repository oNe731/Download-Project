...
public class Weapon_Gun_Effect : MonoBehaviour
{
    ...
    public void Initialize_Effect()
    {
        ...
        m_textures[0] = Resources.Load<Texture2D>("1. Graphic/2D/3. Horror/Effect/Gun/Gun_Light/Gun_Light_1");
        m_textures[1] = Resources.Load<Texture2D>("1. Graphic/2D/3. Horror/Effect/Gun/Gun_Light/Gun_Light_2");
        m_textures[2] = Resources.Load<Texture2D>("1. Graphic/2D/3. Horror/Effect/Gun/Gun_Light/Gun_Light_3");
