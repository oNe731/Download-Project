...
namespace Horror
{
    public class Weapon_Melee : Weapon<HorrorPlayer>
    {
        ...
        {
            base.Enter_Weapon();
            GameManager.Ins.Sound.Play_AudioSource(m_audioSource, "Horror_Weapon_Bbaru_Install", false, 1f);
        }
        ...
        {
            GameManager.Ins.Sound.Play_AudioSource(m_audioSource, "Horror_Weapon_Bbaru_Attack", false, 1f);
